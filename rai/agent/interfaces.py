...
class CaseMemory(Protocol):
    def find_similar_cases(
        self, packet: EvidencePacket, k: int = 5, corpus_partition: str = "all"
    ) -> list[HistoricalCase]: ...
    def get_case_details(self, case_id: str) -> HistoricalCase | None: ...
    def explain_match(self, packet: EvidencePacket, case_id: str) -> dict[str, float]: ...
